...
class CurlBicepsScreen extends StatefulWidget {
  ...
  @override
  _CurlBicepsScreenState createState() => _CurlBicepsScreenState();
}

class _CurlBicepsScreenState extends State<CurlBicepsScreen> {
  List? _data;
  int _imageHeight = 0;
  int _imageWidth = 0;
